Sure, here's an example of how your GitHub README markdown file could look like to explain how to set up and run your Streamlit app named `datagen-basic.py`:
